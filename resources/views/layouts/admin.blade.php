      ...
      <ul class="space-y-2 font-medium mt-6">
        ...
        <li>
          <a href="{{ route('carrusel.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-400 hover:text-white focus:outline focus:ring-2 focus:ring-black">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition duration-75" height="24px" viewBox="0 -960 960 960" width="24px">
              <path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm40-80h480L570-480 450-320l-90-120-120 160Zm-40 80v-560 560Z" />
            </svg>
            <span class="ms-3">Imagenes Carrusel</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="{{ route('mensajes.index') }}" class="flex items-center p-2 rounded-lg hover:bg-gray-400 hover:text-white focus:outline focus:ring-2 focus:ring-black">
