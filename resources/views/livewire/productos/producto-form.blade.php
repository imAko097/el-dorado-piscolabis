                ...
                <div class="px-4 sm:px-6 py-4">
                    <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <!-- Tipo de Producto -->
                            <div>
                                <label for="id_producto_tipo" class="block text-sm font-medium text-gray-700">Tipo de Producto</label>
                                <select wire:model="id_producto_tipo" id="id_producto_tipo"
                        ...
                        <div>
                            ...
                            <div wire:loading wire:target="imagen" class="mt-2">
                                <div class="w-full h-10 bg-gray-200 rounded-md overflow-hidden relative">
                                    <div class="absolute inset-0 bg-blue-500 animate-pulse flex items-center justify-center text-white text-sm font-medium">
                                        Subiendo imagen...
                                    </div>
                                </div>
                            </div>
