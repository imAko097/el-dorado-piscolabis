<div class="min-h-screen bg-yellow-50 py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-lg p-8 text-center border border-yellow-300">
            <div class="mb-6">
                <i class="bi bi-check-circle-fill text-green-500 text-6xl animate__animated animate__tada"></i>
            </div>
            
            <h1 class="text-3xl font-bold mb-4">¡Pedido Realizado con Éxito!</h1>
            
            <span class="text-gray-600">
                Tu pedido ha sido registrado correctamente. En breve, te enviaremos una confirmación por correo electrónico con los detalles. No salgas de la página para saber el estado de tu pedido.
            </span>
